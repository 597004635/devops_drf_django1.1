...
class Idc(models.Model):
    ...
    tel             = models.CharField("联系电话", max_length=15, null=True, blank=True, help_text="联系电话")
...
class Cabinet(models.Model):
    ...
    idc = models.ForeignKey(Idc, verbose_name="所在机柜", help_text="所在机柜")
...
class Manufacturer(models.Model):
    ...
    mail            = models.EmailField("联系邮箱", null=True, blank=True, help_text="联系邮箱")
