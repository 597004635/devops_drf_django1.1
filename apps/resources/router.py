...
from .views import IdcViewset, CabinetViewset, ManufacturerViewset, ProductModelViewset, ProductViewset, ProductManageViewSet, ServerViewset, NetwokDeviceViewset, IPViewset, ServerAutoReportViewset, ServerCountViewset
