    ...
    <div class="zabbix-container">
        <el-row>
            <el-col style="width:25%;text-align:center;padding:10px;">
                <el-progress type="circle" :percentage=monitor_host_percent :stroke-width=15 />
                <div style="width:100%;text-align:center;line-height:40px;">已监控的主机</div>
            </el-col>
            <el-col style="width:25%;text-align:center;padding:10px;">
                <el-progress type="circle" :percentage=success_monitor_percent :stroke-width=15 />
                <div style="width:100%;text-align:center;line-height:40px;">正常监控的主机</div>
            </el-col>
            <el-col style="width:25%;text-align:center;padding:10px;">
                <el-progress type="circle" :percentage=exception_monitor_percent :stroke-width=15  />
                <div style="width:100%;text-align:center;line-height:40px;">异常监控</div>
            </el-col>
            <el-col style="width:25%;text-align:center;padding:10px;">
                <el-progress type="circle" :percentage=not_monitor_percent stroke-width=15 />
                <div style="width:100%;text-align:center;line-height:40px;">未监控</div>
            </el-col>
        </el-row>
        <el-row>
            <el-table v-loading="loading" :data="zabbixProductData" class="table" element-loading-text="拼命加载中" border>
            <el-table-column prop="name" label="业务线" align="center" />
            <el-table-column prop="p=total_host" label="服务器数据" align="center" />
            <el-table-column prop="monitor_total" label="已监控数" align="center" />
            <el-table-column prop="not_monitor" label="未监控数" align="center" />
            <el-table-column prop="problem_disaster" label="disaster" align="center" />
            <el-table-column prop="problem_high" label="high" align="center" />
            <el-table-column prop="problem_average" label="average" align="center" />
            <el-table-column prop="problem_warning" label="warning" align="center" />
            <el-table-column prop="problem_information" label="information" align="center" />
        </el-table>
        </el-row>
    </div>
</template>
